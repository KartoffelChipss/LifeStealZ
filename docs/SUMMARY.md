...
* [🚀 LifeStealZ](README.md)
* [💻 Installation](installation.md)

## Commands

* [👨‍💻 /lifestealz](commands/lifestealz.md)
* [📤 /withdrawheart](commands/withdrawheart.md)
* [❤️ /hearts](commands/hearts.md)
* [💀 /eliminate](commands/eliminate.md)
* [🔮 /revive](commands/revive.md)

## Configuration

* [💬 Messages](configuration/messages.md)
* [🔧 Configuration](configuration/configuration-main.md)
* [🌾 Custom Crafting](configuration/custom-crafting.md)
...
* [🅿️ PlaceholderAPI](cross-plugin-support/placeholderapi.md)
* [🪓 WorldGuard](cross-plugin-support/worldguard.md)
